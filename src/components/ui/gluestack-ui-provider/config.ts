...
export const config = {
  light: vars({
    '--color-primary-0': "230 250 249", /* Muito claro */
    '--color-primary-50': "206 242 241", /* Claro */
    '--color-primary-100': "183 234 233",
    '--color-primary-200': "144 218 217",
    '--color-primary-300': "106 202 200",
    '--color-primary-400': "85 189 187",
    '--color-primary-500': "64 177 175", /* Tom base */
    '--color-primary-600': "58 159 157",
    '--color-primary-700': "49 139 137",
    '--color-primary-800': "37 105 103",
    '--color-primary-900': "29 84 83",
    '--color-primary-950': "17 55 54",

    /* Secondary  */
    '--color-secondary-0': "250 255 254", /* Muito claro */
    '--color-secondary-50': "245 255 254", /* Claro */
    '--color-secondary-100': "240 255 253",
    '--color-secondary-200': "230 255 251",
    '--color-secondary-300': "220 255 249",
    '--color-secondary-400': "210 255 247",
    '--color-secondary-500': "200 255 245", /* Tom base */
    '--color-secondary-600': "190 255 243",
    '--color-secondary-700': "180 255 241",
    '--color-secondary-800': "170 255 239",
    '--color-secondary-900': "150 255 235",
    '--color-secondary-950': "130 255 233", /* Mais escuro */
